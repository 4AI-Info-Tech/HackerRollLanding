  ...
  return (
    <section className="w-full py-20 px-6">
      <div className="mx-auto max-w-5xl text-center">
        <div className="rounded-2xl bg-white/[0.03] border border-white/[0.06] py-16 px-6">
          <h2 className="font-[var(--font-display)] text-3xl sm:text-4xl font-bold text-white mb-4">
            Ready to reimagine<br />Hacker News?
          </h2>
          <p className="text-[#a1a1aa] mb-8 max-w-md mx-auto">
            Download HackerRoll and experience the front page of the internet like never before.
          </p>
          <a
