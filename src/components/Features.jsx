const features = [
  {
    ...
    title: "AI Editorial Illustrations",
    desc: "Every top story gets a unique, AI-generated illustration — turning your feed into a visual magazine.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    title: "Classic HN Feed",
    desc: "The familiar orange list you know and love — stories, comments, and threads, pixel-perfect.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: "Full HN Account Integration",
    desc: "Log in with your HN account to upvote, reply, submit, and favorite — all from the app.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    desc: "Get notified about replies, trending stories, and activity on your submissions.",
  },
  {
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {features.map((f, i) => (
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-[#ff6600]/10 text-[#ff6600] flex items-center justify-center mb-4">
                {f.icon}
              </div>
